    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
            ...
            <ListItem>
              <ListItemIcon>
                <Link to="/orders" style={{textDecoration: 'none', color:"black"}}> <ReceiptIcon /></Link>
              </ListItemIcon>
              <Link to="/order" style={{textDecoration: 'none', color:"black"}}><ListItemText >Orders</ListItemText></Link>
            </ListItem>
            <ListItem>
              <ListItemIcon>
